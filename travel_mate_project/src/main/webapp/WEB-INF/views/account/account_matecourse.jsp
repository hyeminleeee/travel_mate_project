			                        ...
			                        <div class="place-info">
			                            <div class="course_header">
			                                ...
			                                <h2 class="courseTitle">
			                                    <a href="<c:url value='/mate/detail'/>?num=${mateBoard.boardNo}&pageNum=${resultMap.pager.pageNum}&pageSize=${resultMap.pager.pageSize}&column=${searchMap.column}&keyword=${searchMap.keyword}">
			                            ...
			                            <div class="place-rating">
			                                ...
			                                <span class="comments">&nbsp;${mateBoard.boardCount}</span>
			        ...
			        <c:forEach var="i" begin="${resultMap.pager.startPage}" end="${resultMap.pager.endPage}" step="1">
			            <c:choose>
			                <c:when test="${resultMap.pager.pageNum != i}">
			                    <a href="<c:url value='/account/travel_mate'/>?pageNum=${i}&pageSize=${resultMap.pager.pageSize}&column=${searchMap.column}" class="page_count">
			                        ${i}
			                    </a>
			                </c:when>
			                <c:otherwise>
