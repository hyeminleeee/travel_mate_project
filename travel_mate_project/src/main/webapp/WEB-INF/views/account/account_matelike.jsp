...
<div class="container py-5">
	...
	<h1 class="h2 fw-bold">내 좋아요 글 &gt;&gt; 친구모집</h1>
		                ...
		                <c:forEach var="mateBoard" items="${resultMap.mateBoardList}">
		                    <div class="place-item mypage">
		                        ...
		                        <div class="place-info">
		                            ...
		                            <h2 class="courseWriter">${mateBoard.userNickname}</h2>
				        ...
				        <c:forEach var="i" begin="${resultMap.pager.startPage}" end="${resultMap.pager.endPage}" step="1">
				            <c:choose>
				                <c:when test="${resultMap.pager.pageNum != i}">
				                    <a href="<c:url value='/account/travel_matelike'/>?pageNum=${i}&pageSize=${resultMap.pager.pageSize}&column=${searchMap.column}" class="page_count">
				                        ${i}
				                    </a>
				                </c:when>
				                <c:otherwise>
